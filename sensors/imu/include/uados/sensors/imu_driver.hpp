...
/// @brief IMU sensor driver.
class IMUDriver final : public ISensor {
public:
    IMUDriver() = default;
    ~IMUDriver() override;
    ...
    [[nodiscard]] std::string_view name() const override { return "sensors.imu"; }
    [[nodiscard]] Version version() const override { return {0, 1, 0}; }

    // -- ISensor --
    [[nodiscard]] std::shared_ptr<SensorData> read() override;
    [[nodiscard]] SensorType type() const override { return SensorType::IMU; }
